fabric.Canvas.prototype.initialize = function(t) {
...
}(fabric.Canvas.prototype.initialize), fabric.Canvas.prototype.dispose = function(t) {
    return function(...i) {
    ...
    this.historyUndo = [], this.historyRedo = [], this.extraProps = ["selectable"], this.historyNextState = this._historyNext(), this.on(this._historyEvents())
    ...
    this.historyUndo.push(t), this.historyNextState = this._historyNext(), this.fire("history:append", {
        json: t
    })
}, fabric.Canvas.prototype.undo = function(t) {
    if (this.historyProcessing = !0, this.historyUndo.length > 1) {
        const i = this.historyUndo.pop();
        i ? (this.historyRedo.push(this._historyNext()), this.historyNextState = i, this._loadHistory(i, "history:undo", t(i))) : this.historyProcessing = !1
    }
}, fabric.Canvas.prototype.redo = function(t) {
    this.historyProcessing = !0;
    const i = this.historyRedo.pop();
    i ? (this.historyUndo.push(this._historyNext()), this.historyNextState = i, this._loadHistory(i, "history:redo", t)) : this.historyProcessing = !1
}, fabric.Canvas.prototype._loadHistory = function(t, i, s) {
    var o = this;
    this.loadFromJSON(t, (function() {
        o.renderAll(), o.fire(i), o.historyProcessing = !1, s && "function" == typeof s && s()
    }))
